    ...
    <main>
        ...
        <div class="hero-area2  slider-height2 hero-overly2 d-flex align-items-center ">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="hero-cap text-center pt-5">
                            <h2>Loan Offers</h2>
                            <h4>List of Loan Offers, That's Get Easily From Us</h4>
                        </div>
                    </div>
                </div>
        </div>
        ...
        <!-- Services Area Start -->
        <div class="services-area mt-10 mb-10">
            <div class="container">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Installment Loan</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Life funds</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Honest Loans</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Money Pup Loans</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Fast Cash Online</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Fast Loans Group</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Slam Dunk Loans</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Max Cash - Funded Loan</h2>
                                </a>
                ...
                <div class="row justify-content-center mt-5 mb-5">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card d-flex flex-row align-items-center" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); display: flex; justify-content-between;">
                            ...
                            <div class="media-body text-start" style="flex-grow: 1;">
                                <a href="blog_details.html" style="text-decoration: none;">
                                    <h2 class="card-title" style="font-size: 30px !important; color: #333; margin-bottom: 5px;">Payday Loan</h2>
                                </a>
